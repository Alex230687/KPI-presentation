...
SECRET_KEY = 'j32nvb97fn5-bv_*o$9d(auj99ql=e^5txuo=o^9mqsp(y1kkt'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.middlewares.indicator_list_for_navbar',
            ],
            'libraries': {
              'sub_tags': 'main.templatetags.sub_tags'
            },
        },
    },
]
